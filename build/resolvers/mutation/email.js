...
function verifyToken(token, id) {
    ...
    if (checkToken === constants_1.MESSAGES.TOKEN_VERIFICATION_FAILED) {
        return {
            status: false,
            message: 'El periodo para activar el usuario a finalizado. Contacta con el administrador para mas información.',
        };
    }
